...
<link
	...
	rel="stylesheet">
<link
	href="${pageContext.request.contextPath}/resources/css/BoardSelect.css"
...
<body>
	...
	<div class="defaultBanner">
		<img src="${path }/resources/images/default/inquiry_banner.png">
	</div>
	...
	<div class="container3">
		...
		<c:if test="${empty errorMessage}">
			...
			<div class="form-inline">
				<input type="submit" class="btn-primary" value="문의하기"
					onClick="location.href='${path}/inquiry/InquiryInsert.do'">
			</div>
			<table class="table">
				<thead>
					<tr>
				...
				<tbody>
					<c:forEach var="question" items="${ilist}">
						<tr
							onClick="location.href='${path}/inquiry/InquiryDetail?questId=${question.quest_id}'">
			...
			<div class="pagination">
				<c:forEach var="i" begin="1"
					...
					<a
						href="${path}/inquiry/InquirySelect?page=${i}&pageSize=${pageSize}"
