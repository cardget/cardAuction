...
<link rel="stylesheet" href="${path}/resources/css/findResult.css">
...
<body>
	<div class="find-id-container">
		...
		<h6 style="margin-top:0px;"><img src="../resources/icon/blue_error.png">&nbsp;고객님의 정보와 일치하는 ID입니다.</h6>	
			<input type="text" id="id" name="id" class="input-field" placeholder="shinhanDS03" required>
			<img src="../resources/icon/CheckBox_Blue.png">
