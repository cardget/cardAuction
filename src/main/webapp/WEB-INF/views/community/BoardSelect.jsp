...
<body>
    ...
    <div class="search-bar">
        ...
        <input type="text" id="searchKeyword1" placeholder="검색어를 입력해주세요" value="${keyword}">
    ...
    <div class="container">
        ...
        <div class="form-inline">
            ...
            <div class="search-elements">
                ...
                <input type="text" id="searchKeyword" placeholder="검색어를 입력해주세요" value="${keyword}">
        ...
        <div class="pagination">
            <c:forEach var="i" begin="1" end="${(totalCount / pageSize) + (totalCount % pageSize > 0 ? 1 : 0)}">
                <a href="${path}/community/BoardSelect.do?page=${i}&pageSize=${pageSize}&sort=${sort}&keyword=${keyword}&tag=${tag}" class="${i == currentPage ? 'active' : ''}">${i}</a>
            </c:forEach>
        </div>
    </div>
    <script>
        function search() {
            ...
            var url = "${path}/community/BoardSelect.do?page=1&pageSize=${pageSize}&sort=" + sort + "&keyword=" + encodeURIComponent(keyword) + "&tag=" + encodeURIComponent(tag);
            location.href = url;
        }
    </script>
</body>
