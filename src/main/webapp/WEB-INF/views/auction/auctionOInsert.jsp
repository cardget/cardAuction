...
<div class="container">
	...
	<form action="${path}/auction/auctionOInsert.do" class="insert-form" method="post" enctype="multipart/form-data">
		<div class="top-wrapper">
			<h1 class="top-item">원피스 카드 경매 등록</h1>
		...
		<div class="input-container">
		    ...
		    <div class="input-cardKey">
			    ...
			    <select name="o_card_id" class="select-field-card" id="cardSelect">
...
function call() {
    ...
    $.ajax({
        url: '/myapp/auction/searchOnepiece',  
        type: 'GET',
