...
<script>
        function redirectToAuctionInsert() {
            ...
            window.location.href = `${path}/auction/auctionYInsert.do`;
        }
        function sortItems() {
            ...
            window.location.href = `${path}/auction/auctionYMain?sortOption=${sortOption}&keyword=${keyword}`;
        }
...
<div class="containerM">
	<div class="search-area">
            ...
            <div class="search-input-wrapper">
             <form action="${path}/auction/auctionYMain" method="post" class="searchForm">
	 ...
	 <div class="sub-category">
            <ul class="sub-category-box">
                ...
                <li class="main-category-item">
                    <a href="${path}/deckMakers/yugiohDeckListMain">티어덱리스트</a>
                </li>
                <li class="main-category-item">
	...
	<div class="sort-container">
        <div class="sort-item">
            <a href="main.html">홈 > </a><a href="#">유희왕 > </a><a href="#">카드경매</a>
        </div>
        <div class="sort-right">
            <span>정렬기준:</span>
            <form action="${path}/auction/auctionYMain" method="get" id="sortForm">
	...
	<c:forEach var="itemd" items="${itemDlist}">
		<div class="auction-item" >
			<c:choose>
                    ...
                    <c:otherwise>
                        <img src="${path}/resources/image/defaultYCard.png" alt="card image" class="card-image" onclick="location.href='${path}/auction/auctionDetail.do?item_id=${itemd.item_id}'">
                    </c:otherwise>
            </c:choose>
	...
	<!--페이지네이션-->
        <div class="pagination">
            <c:forEach var="i" begin="1" end="${(totalCount / pageSize) + (totalCount % pageSize > 0 ? 1 : 0)}">
                <a href="${path}/auction/auctionYMain?page=${i}&pageSize=${pageSize}&sortOption=${sortOption}&keyword=${keyword}"
