	...
	<c:forEach var="itemd" items="${itemDlist}">
		<div class="auction-item" >
			<c:choose>
                    ...
                    <c:otherwise>
                        <img src="${path}/resources/image/defaultYCard.jfif" alt="card image" class="card-image" onclick="location.href='${path}/auction/auctionDetail.do?item_id=${itemd.item_id}'">
                    </c:otherwise>
            </c:choose>
