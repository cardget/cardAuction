...
<div class="container">
	...
	<form action="${path}/auction/auctionYInsert.do" class="insert-form" method="post" enctype="multipart/form-data">
		<div class="top-wrapper">
			<h1 class="top-item">유희왕 카드 경매 등록</h1>
		...
		<div class="input-container">
		    ...
		    <div class="input-cardKey">
			    ...
			    <select name="y_card_id" class="select-field-card" id="cardSelect">
...
function call() {
    ...
    $.ajax({
        url: '/myapp/auction/searchYugioh',  
        type: 'GET',
