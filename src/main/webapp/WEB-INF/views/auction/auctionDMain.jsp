...
<script>
        function redirectToAuctionInsert() {
            ...
            window.location.href = `${path}/auction/auctionDInsert.do`;
        }
        function sortItems() {
            ...
            window.location.href = `${path}/auction/auctionDMain?sortOption=${sortOption}&keyword=${keyword}`;
        }
...
<div class="containerM">
	<div class="search-area">
            ...
            <div class="search-input-wrapper">
             <form action="${path}/auction/auctionDMain" method="post" class="searchForm">
	...
	<div class="sort-container">
        <div class="sort-item">
            <a href="main.html">홈 > </a><a href="#">디지몬 > </a><a href="#">카드경매</a>
        </div>
        <div class="sort-right">
            <span>정렬기준:</span>
            <form action="${path}/auction/auctionDMain" method="get" id="sortForm">
	...
	<!--페이지네이션-->
        <div class="pagination">
            <c:forEach var="i" begin="1" end="${(totalCount / pageSize) + (totalCount % pageSize > 0 ? 1 : 0)}">
                <a href="${path}/auction/auctionDMain?page=${i}&pageSize=${pageSize}&sortOption=${sortOption}&keyword=${keyword}"
