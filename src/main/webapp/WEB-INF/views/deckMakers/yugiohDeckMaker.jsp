...
<body>
		...
		<div class="main-content-2">
			<div class="accordion">
				<div class="accordion-item">
					<div class="accordion-header">유희왕</div>
				...
				<div class="moreBtn">
					<button type="button" id="loadMoreYBtn">더보기</button>
				</div>
			</div>
		</div>
		<div class="deck-list">
    ...
    function insertCard(){
		...
		let currentPageY = 1;
		document.getElementById('loadMoreYBtn').addEventListener('click', function() {

		    currentPageY++;
		    console.log(currentPageY);
		    fetch("/myapp/deckMakers/loadMoreYCard.do?page=" + currentPageY)
		        .then(response =>  
		        response.json() 
		        )
		        .then(data => {
