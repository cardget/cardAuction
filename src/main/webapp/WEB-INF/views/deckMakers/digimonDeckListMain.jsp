			...
			<div class="sort-nav">
				<ul class="sort-box">
					...
					<li class="sort-item">정렬기준 : <select class="sort-select"
						onchange="location.href='${path}/deckMakers/digimonDeckListMain.do?sort=' + this.value">
			...
			<ul class="option-box">
				<li class="option-item">
					<form id="conditionForm"
						action="${path}/deckMakers/digimonDeckListMain.do" method="get">
				...
				<li class="option-item">
					<button type="button" class="create-deck"
						onclick="location.href='${path}/deckMakers/digimonDeckMaker.do'">덱
						생성</button>
				</li>
			</ul>
		</div>
